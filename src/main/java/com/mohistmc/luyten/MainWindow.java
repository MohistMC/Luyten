...
public class MainWindow extends JFrame {
	...
	private static final String TITLE = "Mohsit-Luyten";
	...
	public MainWindow(File fileFromCommandLine) {
		...
		this.setTitle(TITLE);
		this.setIconImage(new ImageIcon(Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/Luyten.png"))).getImage());
