...
public class Model extends JSplitPane {
    ...
    private final MoWuDecompTypeLoader typeLoader = new MoWuDecompTypeLoader();
    ...
    public Model(MainWindow mainWindow) {
        ...
        try {
            ...
            setTheme(Theme.load(getClass().getResourceAsStream(MoWuDecompPreferences.THEME_XML_PATH + themeXml)));
        } catch (Exception e) {
            try {
                MoWuDecomp.showExceptionDialog("Exception!", e);
                String themeXml = MoWuDecompPreferences.DEFAULT_THEME_XML;
                luytenPrefs.setThemeXml(themeXml);
                setTheme(Theme.load(getClass().getResourceAsStream(MoWuDecompPreferences.THEME_XML_PATH + themeXml)));
            } catch (Exception e1) {
                MoWuDecomp.showExceptionDialog("Exception!", e1);
            }
        }
        ...
        KeyStroke sfuncF4 = KeyStroke.getKeyStroke(KeyEvent.VK_F4, com.mohistmc.mowudecomp.Keymap.ctrlDownModifier(), false);
    ...
    public void openEntryByTreePath(TreePath trp) {
        ...
        try {
            ...
            MoWuDecomp.showExceptionDialog("Unable to open file!", e);
        } finally {
                ...
                public void mouseClicked(MouseEvent e) {
                    if (onCloseTabAction != null && SwingUtilities.isMiddleMouseButton(e)) {
                        try {
                            ...
                            MoWuDecomp.showExceptionDialog("Exception!", ex);
                        }
                    }
                }
            });*/
    ...
    public void loadTree() {
        new Thread(() -> {
            try {
                ...
                MoWuDecomp.showExceptionDialog("Cannot open " + file.getName() + "!", e);
    ...
    public void changeTheme(String xml) {
        InputStream in = getClass().getResourceAsStream(MoWuDecompPreferences.THEME_XML_PATH + xml);
        try {
            if (in != null) {
    ...
    public void navigateTo(final String uniqueStr) {
        new Thread(() -> {
            ...
            try {
                ...
                MoWuDecomp.showExceptionDialog("Cannot Navigate!", e);
            } finally {
                bar.setVisible(false);
            }
        }).start();
